...
<div class="jumbotron">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-6">
                <a href="{{ route('doctor.home') }}" class="btn btn-primary float-right btn-lg">Add Visit</a>
            </div>
        </div>
    </div>
</div>
...
<div class="container">
    ...
    <a class="btn btn-primary" href="{{ route('doctor.home') }}" role="button">Go Back To Dashboard</a>
</div>
@endsection
