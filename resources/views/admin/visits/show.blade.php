...
<div class="container">
    ...
    <div class="row mt-5 mb-3">
        <div class="col-6">
            ...
            <table class="table table-hover table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td>{{ $visit->patient->insurance_company }}-{{ $visit->patient->insurance_policy_no }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
        <div class="col-6">
            ...
            <a class="btn btn-primary" href="{{ route('admin.visits.index') }}" role="button">Go Back To Visits</a>
        </div>
    </div>
